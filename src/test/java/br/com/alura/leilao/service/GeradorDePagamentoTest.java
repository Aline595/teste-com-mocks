...
class GeradorDePagamentoTest {
	...
	@Mock
	private Clock clock; // cria relogio na mock
	...
	void deveriaCriarPagamentoParaVencedorDoLeilao() {
		...
		LocalDate data = LocalDate.of(2021, 07, 07); // define data
		...
		Mockito.verify(pagamentoDao).salvar(captor.capture()); // salva objeto criado
